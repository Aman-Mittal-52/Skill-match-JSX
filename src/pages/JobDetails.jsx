                    ...
                    <Card className="max-w-7xl mx-auto mb-8">
                            ...
                            <div className="space-y-6 mb-8">
                                ...
                                <div className="flex flex-wrap gap-4">
                                    <div className="flex items-center text-gray-600">
                                        ...
                                        <span className="text-sm sm:text-base">{currentJob.location}</span>
                                    </div>
                                    <div className="flex items-center text-gray-600">
                        ...
                        <CardFooter className="flex flex-col sm:flex-row gap-4">
                            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                                {currentJob.mobileNumber && (
                                    <Button
                                        variant="outline"
                                        className="flex items-center justify-center gap-2 bg-blue-50 text-blue-700 border-blue-200 w-full sm:w-auto"
                                        onClick={() => {
                                            window.open(`tel:${currentJob.mobileNumber}`, '_self');
                                        }}
                                    >
                                ...
                                {currentJob.whatsappNumber && (
                                    <Button
                                        variant="outline"
                                        className="flex items-center justify-center gap-2 bg-green-50 text-green-700 border-green-200 w-full sm:w-auto"
                                        onClick={() => {
                            ...
                            {
                                user.role === 'recruiter' ? (
                                    <Button className='w-full sm:flex-1 cursor-not-allowed'>
                                    ...
                                    <Button
                                        ...
                                        onClick={handleApply}
                                        disabled={applicationStatus === 'loading' || user.role === 'recruiter' || user.role === 'admin'}
                                    >
